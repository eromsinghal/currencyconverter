...
const countries = [
        { code: "AED", name: "United Arab Emirates Dirhams"},
        ...
        { code: "ZWL", name: "Zimbabwean Dollar (2009)"},
...
const getExchangeRate = async () =>
{
    ...
    try
    {
        ...
        const response = await fetch(`https://v6.exchangerate-api.com/v6/94cd447ced60378242015631/latest/${fromCurrency}`);
